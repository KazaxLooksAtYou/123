...
ЗапуститьПриложениеСобработкойРезультат("git config --local core.quotepath false", КаталогНовогоРепозитория, "Не удалось включить поддержку русских имен файлов");
...
Если ПозицияРазделителя <> 0 Тогда
    ...
    Сообщить("Каталоги vanessa-bootstrap созданы успешно!");  
